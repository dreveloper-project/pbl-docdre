                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-3 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="#submenu1" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                            </i> <span class="ms-1 d-none d-sm-inline">Surat Tugas</span> <i class="fa fa-file-text-o" aria-hidden="true"></i> </a>
                        <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                            <li class="w-100">
                                <a href="#" class="nav-link px-0"> <span class="d-none d-sm-inline">Terbitkan</span> </a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="<?= BASE_URL ?>admin/user"  class="nav-link px-0 align-middle">
                             <span class="ms-1 d-none d-sm-inline">Notifikasi</span> <i class="fa fa-bell" aria-hidden="true"></i> </a>
                    </li>
                </ul>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse">
      ...
      <ul class="navbar-nav ms-auto">
       ...
       <h1 class='mt-5 ml-8'>Selamat Datang <?=  $_SESSION['logged_in'] ?></h1>
